...
<CardGroup cols={3}>
  <Card href="/developers/metadata-system" img="/images/user-guide/integrations/plug.png">
    <CardTitle>JSON-schema driven metadata system</CardTitle>
    Learn about our dynamic Firestore-native metadata engine.
  </Card>
